      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
        <Row gutter={[24, 24]} justify="center">
          <Col xs={24} lg={12} style={{ textAlign: 'center' }}>
            <Title
              level={3}
              style={{ color: '#1890ff', marginBottom: '16px', textAlign: 'center' }}
            >
              張哲珉的 Side Project
            </Title>
            ...
            <Space size="large" style={{ marginTop: '20px', justifyContent: 'center' }}>
              ...
              <a href="mailto:a27046955@gmail.com" style={{ fontSize: '24px', color: '#1890ff' }}>
                <MailOutlined />
              </a>
            </Space>
          </Col>
        ...
        <Row justify="space-between" align="middle">
          ...
          <Col>
            <Text style={{ color: '#999' }}>Built with React, TypeScript & Spring boot API</Text>
          </Col>
        </Row>
      </div>
    </footer>
